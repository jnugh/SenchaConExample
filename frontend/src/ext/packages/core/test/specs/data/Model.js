describe("Ext.data.Model", function() {
    ...
    describe("defining models", function() {
        ...
        describe("proxy", function() {
            ...
            it("should use the defaultProxy instead of the schema proxy", function() {
                defineA(null, {
                    statics: {
                        defaultProxy: { type: 'memory' }
                    }
                });
                var schema = A.schema,
                    schemaConfig = schema.constructProxy(A),
            ...
            describe("subclassing", function() {
                ...
                it("should not use the defaultProxy when defaultProxy is defined on parent", function() {
                    defineA(null, {
                        statics: {
                            defaultProxy: { type: 'memory' }
                        }
                    ...
                    defineB();
                    var schema = B.schema,
                        schemaConfig = schema.constructProxy(B),
                        proxy = B.getProxy();
            ...
            it("should use a memory proxy for direct instances of Ext.data.Model", function() {
                var model = new Ext.data.Model();

                expect(model.getProxy().isMemoryProxy).toBe(true);
            });

            it("should use a memory proxy for direct instances of Ext.data.TreeModel", function() {
